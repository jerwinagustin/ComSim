...
const AfterBuildingQuiz = ({ navigation, route }) => {
  return (
    <LinearGradient colors={['#E2DFDF', '#ffffff']} style={styles.gradient}>
      <View style={styles.container}>
        <View style={styles.middleContainer}>
          <Text style={styles.buildTitle}>SetUpQuiz</Text>
        </View>
        <View style={styles.bottomContainer}>
          <TouchableOpacity 
            onPress={() => navigation.navigate('AfterBuildingScreen', { onGoBack: route.params?.onGoBack })}
          >
...
export default AfterBuildingQuiz